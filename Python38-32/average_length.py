...
average_length = (
            length_of_spaceless_string / res)  # assigns variable to average_length; calculated by dividing res(number of words in the string) by length of spaceless string
